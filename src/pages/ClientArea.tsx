...
type CustomerDetails = CustomerPublic & {
  email: string;
  telefone: string;
  cpf: string;
};
...
const BARBERS: Record<string, QuickBarber> = {
  carlos: { id: "10", name: "Carlos Silva", photo: "https://i.pravatar.cc/480?img=12" },
  joao: { id: "11", name: "João Pereira", photo: "https://i.pravatar.cc/480?img=32" },
  rafael: { id: "12", name: "Rafael Souza", photo: "https://i.pravatar.cc/480?img=28" },
};
...
const MOCK_RECENT_SERVICES: Array<{
...
}> = [
  {
    ...
    service: { id: "corte", name: "Corte", price: "R$ 30,00", duration: "30min" },
    barber: BARBERS.carlos,
  },
  {
    id: "s2",
    title: "Barba",
    ...
    service: { id: "barba", name: "Barba", price: "R$ 30,00", duration: "30min" },
    barber: BARBERS.joao,
  },
  {
    id: "s3",
    ...
    service: { id: "corte-barba", name: "Corte + Barba", price: "R$ 60,00", duration: "1h30min" },
    barber: BARBERS.rafael,
  },
];
...
export default function ClientAreaPage() {
  ...
  const handleQuickBook = useCallback((service: QuickService, barber: QuickBarber) => {
    setService(service);
    setBarber(barber);
    navigate(`/agendamento?step=2`);
  }, [navigate, setBarber, setService]);

  /* Ao abrir o modal, busca os detalhes (view=details) */
  ...
  /* Salvar edição: PUT retorna apenas view pública (id + nome) */
    ...
    <Box sx={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
                ...
                <CardContent sx={{ pb: 0 }}>
                  ...
                  <List disablePadding dense sx={{ mt: 1 }}>
                    {recentItems.map((item) => (
                      ...
                      >
                        <ListItemAvatar>
                          <Avatar variant="rounded" sx={{ bgcolor: "rgba(14,165,233,0.15)" }}>
                            {item.icon}
                          </Avatar>
                        </ListItemAvatar>
                        <ListItemText
      ...
      <Dialog open={openEdit} onClose={() => setOpenEdit(false)} fullWidth maxWidth="sm">
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={saveEdit} disabled={!form}>
            Salvar
          </Button>
        </DialogActions>
      </Dialog>
